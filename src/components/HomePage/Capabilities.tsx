      ...
      <div className="col-3">
        <div className="d-flex justify-content-center">
          <div
            ...
            <div className="d-flex justify-content-center col-3">
              <FaCog size={30} color={iconColors.cog} />
            </div>
            <div className="col-9">
              <h4>APIs</h4>
      ...
      <div className="col-3">
        <div className="d-flex justify-content-center">
          <div
            ...
            <div className="d-flex justify-content-center col-3">
              <FaServer size={30} color={iconColors.server} />
            </div>
            <div className="col-9">
              <h4>Microservices</h4>
              <p>
                Creation of microservices using Docker containers and Azure services, being Azure Kubernetes Service
                etc.
              </p>
            </div>
          </div>
